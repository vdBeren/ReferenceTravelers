...
class RTTextWindow: RTWindow {
    ...
    func refreshContents(){
        ...
        heroSelected = GCurrentHero
        heroAttributes = GCurrentHero.attributes
        ...
        self.labelQuoteText!.text = heroSelected.quote
    ...
    private func initContents(){
        ...
        self.labelQuoteText = RTLabelText(text: "\"\(heroSelected.quote)\"", fontSize: fontSize - 2, minimum: 7)
